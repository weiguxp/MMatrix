...
namespace ProtoBuf
{
        ...
        class Serializer
    {
        ...
        public static object Deserialize(Stream source, object value)
        {
            return RuntimeTypeModel.Default.Deserialize(source, value, value.GetType());
        }
        /// <summary>
...
#if PLAT_BINARYFORMATTER && !NO_GENERICS
        /// <summary>
